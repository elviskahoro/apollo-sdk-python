...
class LabelsResource(SyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        """
        Use the Get a List of All Lists endpoint to retrieve information about every
        list that has been created in your Apollo account. This endpoint can be used to
        check the available lists before you use the
