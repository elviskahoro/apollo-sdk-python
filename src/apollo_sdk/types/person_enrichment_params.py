...
__all__ = ["PersonEnrichmentParams"]


class PersonEnrichmentParams(TypedDict, total=False):
    id: str
    ...
    """
    Set to `true` if you want to enrich the person's data with all available phone
