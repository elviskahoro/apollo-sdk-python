...
from ._exceptions import ApolloSDKError, APIResponseValidationError
...
class BaseAPIResponse(Generic[R]):
    ...
    def _parse(self, *, to: type[_T] | None = None) -> R | _T:
        ...
        if (
            ...
            raise TypeError("Pydantic models must subclass our base model type, e.g. `from apollo import BaseModel`")
...
class StreamAlreadyConsumed(ApolloSDKError):
    """
