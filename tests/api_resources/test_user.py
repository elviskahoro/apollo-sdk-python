...
class TestUser:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_path_params_delete(self, client: ApolloSDK) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `username` but received ''"):
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_method_create_with_list(self, client: ApolloSDK) -> None:
        user = client.user.create_with_list()
        assert_matches_type(User, user, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_method_create_with_list_with_all_params(self, client: ApolloSDK) -> None:
        user = client.user.create_with_list(
            body=[
                {
                    "id": 10,
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_raw_response_create_with_list(self, client: ApolloSDK) -> None:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_streaming_response_create_with_list(self, client: ApolloSDK) -> None:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_method_login(self, client: ApolloSDK) -> None:
        user = client.user.login()
        assert_matches_type(str, user, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_method_login_with_all_params(self, client: ApolloSDK) -> None:
        user = client.user.login(
            password="password",
            username="username",
        )
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_raw_response_login(self, client: ApolloSDK) -> None:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_streaming_response_login(self, client: ApolloSDK) -> None:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_method_logout(self, client: ApolloSDK) -> None:
        user = client.user.logout()
        assert user is None

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_raw_response_logout(self, client: ApolloSDK) -> None:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_streaming_response_logout(self, client: ApolloSDK) -> None:
...
class TestAsyncUser:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_path_params_delete(self, async_client: AsyncApolloSDK) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `username` but received ''"):
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_method_create_with_list(self, async_client: AsyncApolloSDK) -> None:
        user = await async_client.user.create_with_list()
        assert_matches_type(User, user, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_method_create_with_list_with_all_params(self, async_client: AsyncApolloSDK) -> None:
        user = await async_client.user.create_with_list(
            body=[
                {
                    "id": 10,
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_raw_response_create_with_list(self, async_client: AsyncApolloSDK) -> None:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_streaming_response_create_with_list(self, async_client: AsyncApolloSDK) -> None:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_method_login(self, async_client: AsyncApolloSDK) -> None:
        user = await async_client.user.login()
        assert_matches_type(str, user, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_method_login_with_all_params(self, async_client: AsyncApolloSDK) -> None:
        user = await async_client.user.login(
            password="password",
            username="username",
        )
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_raw_response_login(self, async_client: AsyncApolloSDK) -> None:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_streaming_response_login(self, async_client: AsyncApolloSDK) -> None:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_method_logout(self, async_client: AsyncApolloSDK) -> None:
        user = await async_client.user.logout()
        assert user is None

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_raw_response_logout(self, async_client: AsyncApolloSDK) -> None:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_streaming_response_logout(self, async_client: AsyncApolloSDK) -> None:
